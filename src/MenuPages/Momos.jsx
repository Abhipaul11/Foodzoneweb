  ...
  return (
    <>
      ...
      >
        ...
        >
          <Card
            Menuimg="https://www.crazymasalafood.com/wp-content/images/tandoori-momos-1.jpg"
            Menu="Tandoori Momos (100)"
        ...
        >
          <Card
            Menuimg="https://www.crazymasalafood.com/wp-content/images/steamed-momos.jpg"
            Menu="Steamed Momos(150)"
        ...
        >
          <Card
            Menuimg="https://www.crazymasalafood.com/wp-content/images/chocolate-momos.jpg"
            Menu="Chocolate Momos(90)"
            para="loremjyhcujujyuj"
            price="180"
            off="16% off"
          />
        ...
        >
          <Card
            Menuimg="https://www.crazymasalafood.com/wp-content/images/chilly-momos.jpg"
            Menu="Chilly Momos(80)"
            para="loremjyhcujujyuj"
            price="180"
            off="34% off"
          />
        ...
        >
          <Card
            Menuimg="https://www.crazymasalafood.com/wp-content/images/kothe-momos.jpg"
            Menu="Kothe Momos(100)"
            para="loremjyhcujujyuj"
            price="180"
            off="17% off"
          />
        ...
        >
          <Card
            Menuimg="https://www.crazymasalafood.com/wp-content/images/soup-momos.jpg"
            Menu="Soup Momos(160)"
            para="loremjyhcujujyuj"
            price="180"
            off="34% off"
        ...
        >
          <Card
            Menuimg="https://crazymasalafood.com/wp-content/images/cheese-momos.jpg.webp"
            Menu="Cheese Momos(250)"
            para="loremjyhcujujyuj"
            price="180"
            off="45% off"
          />
        ...
        >
          <Card
            Menuimg="https://www.crazymasalafood.com/wp-content/images/qeema-momos.jpg"
            Menu="Qeema Momos(60)"
            para="loremjyhcujujyuj"
            price="180"
            off="29% off"
